...
print('Bem vindo! Este programa recebe dois números inteiros e realiza várias operações.')
...
print(f'\nO primeiro valor vezes o segundo: {numero1 * numero2}'
      ...
      f'\nO inverso do primeiro valor vezes o segundo multiplicado por 5: {((1/numero1) * (numero2 * 5)):.1f}'
